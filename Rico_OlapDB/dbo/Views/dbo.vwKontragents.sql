...
AS
SELECT     dbo.V8_Reference213.V8_ID, dbo.V8_Reference213.V8_Fld313 AS Region_ID, dbo.V8_Reference213.V8_Description, dbo.V8_Reference213.V8_Fld302 AS FullName, 
                      dbo.V8_Reference213.V8_Code, dbo.V8_Reference213.V8_Marked, dbo.V8_Reference213.V8_Parent, dbo.V8_Reference213.V8_Folder, 
                      dbo.V8_Reference291.V8_Description AS Region, dbo.V8_Reference213.V8_Fld325 AS City, dbo.V8_Reference213.V8_Fld326 AS Category_ID, 
